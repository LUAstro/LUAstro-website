...
letting it take a current Z-index of zero (it's a layer behind the basis HTML),
  ...
  This code is simply the same as the standard Lightbox.js code, but modified
       to work with the image-row div tags seen on the History page.

*/
(function() {
    const figures   = Array.from(document.querySelectorAll('.image-row figure'));
